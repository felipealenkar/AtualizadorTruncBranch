...
@echo off
chcp 65001 > nul
title Atualização da Trunc Shop Simples com Robocopy
color 0A
...
if %errorlevel% neq 0 (
    ...
    echo 2. Clique com o BOTAO DIREITO no arquivo "TruncShopSimples.bat".
...
echo ========================================================================================================
echo            INICIANDO ATUALIZAÇÃO DA TRUNC SHOP SIMPLES
echo ========================================================================================================
echo.
...
call :VERIFICAR_PASTA "%ORIGEM1%" "SE > Shop"
...
robocopy "%ORIGEM1%" "%DESTINO1%" /E /ZB /R:1 /W:2 /V
