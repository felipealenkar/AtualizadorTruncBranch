...
call :VERIFICAR_PASTA "%ORIGEM1%" "ACE > Concentrador"
call :VERIFICAR_PASTA "%ORIGEM2%" "ACE > PDVAlterdata"
call :VERIFICAR_PASTA "%ORIGEM3%" "PDV > Biblioteca"
call :VERIFICAR_PASTA "%ORIGEM4%" "PLUGIN > MODPDV"
call :VERIFICAR_PASTA "%ORIGEM5%" "DLL > Biblioteca"
call :VERIFICAR_PASTA "%ORIGEM6%" "tokyo > Biblioteca"
call :VERIFICAR_PASTA "%ORIGEM7%" "Alexandria > Biblioteca"
call :VERIFICAR_PASTA "%ORIGEM8%" "Exe > PDV Alterdata"
call :VERIFICAR_PASTA "%ORIGEM9%" "Alexandria > Concentrador"
call :VERIFICAR_PASTA "%ORIGEM10%" "Alexandria > IntegradorPDV"
call :VERIFICAR_PASTA "%ORIGEM11%" "Alexandria > PDV Alterdata"
call :VERIFICAR_PASTA "%ORIGEM12%" "Alexandria > PreVenda"
call :VERIFICAR_PASTA "%ORIGEM13%" "Alexandria > Lays"
call :VERIFICAR_PASTA "%ORIGEM14%" "Rtm_NFCe > DanfeNFCe"
call :VERIFICAR_PASTA "%ORIGEM15%" "Rtm_NFCe > VendaFutura"
...
robocopy "%ORIGEM1%" "%DESTINO1%" "ISHOP_Ribbon.ACE" "WSHOP_Ribbon.ACE" /ZB /R:1 /W:2 /V 
if errorlevel 8 goto ERRO

echo 📁 Copiando para PDV Alterdata...
robocopy "%ORIGEM2%" "%DESTINO2%" "ISHOP_Ribbon.ACE" "WSHOP_Ribbon.ACE" /ZB /R:1 /W:2 /V 
if errorlevel 8 goto ERRO

echo 📁 Copiando para Biblioteca...
robocopy "%ORIGEM3%" "%DESTINO3%" /E /ZB /R:1 /W:2 /V ❌ /XD "DCP" "PLUGIN" 
if errorlevel 8 goto ERRO

echo 📁 Copiando para MODPDV...
robocopy "%ORIGEM4%" "%DESTINO4%" /E /ZB /R:1 /W:2 /V ❌ /XD "ERP" 
if errorlevel 8 goto ERRO

echo 📁 Copiando para Biblioteca...
robocopy "%ORIGEM5%" "%DESTINO5%" /E /ZB /R:1 /W:2 /V ❌ /XD "tokyo" "Alexandria"
if errorlevel 8 goto ERRO
